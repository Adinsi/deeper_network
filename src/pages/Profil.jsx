      ...
      <div className="container-fluid d-flex align-items-center">
        <div className="row">
          <div className="col-lg-7 col-md-10">
            ...
            <p className="text-white mt-0 mb-5">Deep social network est un site dédié au jeune professionnel de l'église biblique de la vie profonde. L'usage de ce site à caractère douteux seras bannir du plateforme définitivement et poursuivi en cas de faute majeure.</p>
            ...
            <div className="card-header bg-white border-0">
              <div className="row align-items-center">
                ...
                <div className="col-4 text-right">
                  <a href="#!" className="btn btn-sm btn-primary">paramètres</a>
                </div>
              </div>
            </div>
